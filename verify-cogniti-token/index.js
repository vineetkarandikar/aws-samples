...
class Verifier {
  ...
  async verify(token) {
    ...
    try {
      ...
      verifiedToken = await jose.JWS.createVerify(joseKey).verify(token);
      ...
      result = {"status":true,"payload":verifiedToken.payload};
      return result;
    } catch (e) {
      console.log(e);
      result = {"status":false,"payload":verifiedToken.payload};
      return result;
    }
  }
